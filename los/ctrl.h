...
inline int genACnum(int plugin, int ctrl)
{
    return (plugin + 1) * AC_PLUGIN_CTL_BASE + ctrl;
}
...
enum CtrlValueType
{
    VAL_LOG, VAL_LINEAR, VAL_INT, VAL_BOOL
};

enum CtrlRecValueType
{
    ARVT_VAL, ARVT_START, ARVT_STOP
};
