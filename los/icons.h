...
extern QIcon* transport_stopIconLeftOn;
extern QIcon* transport_stopIconLeftOff;
extern QIcon* transport_stopIconLeftOver;
extern QIcon* stopIconSetLeft;
...
extern QPixmap* selectMultiIcon;
