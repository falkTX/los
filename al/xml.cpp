...
namespace AL {
    ...
    void Xml::writeProperties(const QObject* o)
    {
        ...
        //
        // start from dummy "los" property, assuming this is the
        // first los propertie in widget hierarchy
        //
        int from = meta->indexOfProperty("los") + 1;
        ...
        for (int i = from; i < n; ++i)
        {
            ...
            switch (v.type())
            {
                ...
                default:
                    printf("LOS:%s type %d not implemented\n",
